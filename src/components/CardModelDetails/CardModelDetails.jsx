    ...
    return (
        <div className="row cstm-row p-2">
            {info.map((info, index) => {
                ...
                if (model === "Historia") {
                    return (
                        <div className="col-xs-4 col-sm-4 col-md-4 col-xl-4 col-lg-4 container-details" key={index}>
                    ...
                    return (
                            info.modelos.map((modelo, index) => {
                                count++;
                                return (
                                    <div className="col-xs-4 col-sm-4 col-md-4 col-xl-4 col-lg-4 container-details-item" key={index}>
                                        <div
